...
export default function Home() {
  ...
  // Track category clicks for stats
  useEffect(() => {
    if (!category) return;
  ...
  function copyTip() {
    if (tip && tip !== 'Click "Next Tip" to get a tip!' && tip !== 'Error fetching tip. Please try again.') {
  ...
  function shareTip() {
    if (navigator.share && tip && tip !== 'Click "Next Tip" to get a tip!' && tip !== 'Error fetching tip. Please try again.') {
      ...
      <div className="col-md-4">
        <div style={{ height: '150px' }} className="svg-pulse">
          <svg width="100%" height="100%" viewBox="0 0 64 64" fill="none">
            ...
            <path d="M32 16a8 8 0 1 1-6.3 13.1L20 44h4l3-6h10l3 6h4l-5.7-14.9A8 8 0 0 1 32 16z" fill="#43A047"/>
          </svg>
        </div>
      ...
      <div className="col-md-4">
        <div style={{ height: '150px' }} className="svg-rotate">
          <svg width="100%" height="100%" viewBox="0 0 64 64" fill="none">
            ...
            <path d="M20 30c0 6.6 5.4 12 12 12s12-5.4 12-12" stroke="#FBC02D" strokeWidth="3" strokeLinecap="round" />
